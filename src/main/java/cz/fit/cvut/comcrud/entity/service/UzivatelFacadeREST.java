...
import cz.fit.cvut.comcrud.entity.Uzivatel;
 ...
 */
@Stateless
@Path("cz.fit.cvut.comcrud.entity.uzivatel")
public class UzivatelFacadeREST extends AbstractFacade<Uzivatel> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
	public void edit(@PathParam("id") BigDecimal id, Uzivatel entity) {
		super.edit(entity);
	}
	...
	public Uzivatel find(@PathParam("id") BigDecimal id) {
