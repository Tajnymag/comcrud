...
public class NarodnostFacadeREST extends AbstractFacade<Narodnost> {
	...
	public void create(Narodnost entity) {
		super.create(entity);
	}
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
	public void edit(@PathParam("id") BigDecimal id, Narodnost entity) {
		super.edit(entity);
	}
	...
	public Narodnost find(@PathParam("id") BigDecimal id) {
